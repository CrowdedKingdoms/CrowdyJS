// Generated from assets/browser-authoring-index.json. Do not edit by hand.
  ...
  "symbols": [
    {
      ...
      "name": "format",
      "kind": "macro",
      "signature": "format!(format_string, ...)",
      "docs": "Creates a formatted String."
    },
    {
      "module": "alloc",
      "name": "vec",
      ...
      "docs": "Creates a Vec from values or a repeated value."
    },
    {
      "module": "alloc::boxed",
      "name": "Box",
      "kind": "struct",
      "signature": "pub struct Box<T>",
      "docs": "An owned heap allocation."
    },
    {
      "module": "alloc::string",
      "name": "String",
    ...
    },
    {
      ...
      "docs": "Panics when a condition is false."
    },
    {
      "module": "core",
      "name": "assert_eq",
      "kind": "macro",
      "signature": "assert_eq!(left, right[, message])",
      "docs": "Panics when two expressions are not equal."
    },
    {
      "module": "core",
      "name": "matches",
      "kind": "macro",
      "signature": "matches!(expression, pattern [if guard])",
      "docs": "Checks whether an expression matches a pattern."
    },
    {
      "module": "core",
      "name": "panic",
      ...
      "docs": "Terminates the current execution with an error."
    },
    {
      "module": "core::mem",
      "name": "drop",
      "kind": "function",
      "signature": "pub fn drop<T>(_x: T)",
      "docs": "Consumes and drops a value."
    },
    {
      "module": "core::mem",
      "name": "forget",
      "kind": "function",
      "signature": "pub const fn forget<T>(t: T)",
      "docs": "Consumes a value without running its destructor."
    },
    {
      "module": "core::prelude::v1",
      "name": "Clone",
      "kind": "trait",
      "signature": "pub trait Clone { fn clone(&self) -> Self; }",
      "docs": "Explicitly duplicates a value."
    },
    {
      "module": "core::prelude::v1",
      "name": "Copy",
      "kind": "trait",
      "signature": "pub trait Copy: Clone",
      "docs": "Marks values duplicated by assignment."
    },
    {
      "module": "core::prelude::v1",
      "name": "Default",
      "kind": "trait",
      "signature": "pub trait Default { fn default() -> Self; }",
      "docs": "Constructs a useful default value."
    },
    {
      "module": "core::prelude::v1",
      "name": "Err",
      "kind": "variant",
      "signature": "Err(E) -> Result<T, E>",
      "docs": "Constructs an error Result value."
    },
    {
      "module": "core::prelude::v1",
      "name": "IntoIterator",
      "kind": "trait",
      "signature": "pub trait IntoIterator { type Item; type IntoIter: Iterator<Item = Self::Item>; }",
      "docs": "Converts a value into an iterator."
    },
    {
      "module": "core::prelude::v1",
      "name": "Iterator",
      "kind": "trait",
      "signature": "pub trait Iterator { type Item; fn next(&mut self) -> Option<Self::Item>; }",
      "docs": "Produces a sequence of values."
    },
    {
      "module": "core::prelude::v1",
      "name": "None",
      "kind": "variant",
      "signature": "None -> Option<T>",
      "docs": "Constructs an absent Option value."
    },
    {
      "module": "core::prelude::v1",
      "name": "Ok",
      "kind": "variant",
      "signature": "Ok(T) -> Result<T, E>",
      "docs": "Constructs a successful Result value."
    },
    {
      "module": "core::prelude::v1",
      "name": "Option",
    ...
    },
    {
      ...
      "docs": "A success value or an error."
    },
    {
      "module": "core::prelude::v1",
      "name": "Some",
      ...
      "docs": "Constructs a present Option value."
    },
    {
      "module": "core::slice",
      "name": "from_raw_parts",
