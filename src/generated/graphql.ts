...
export type FunctionNotificationInput = {
  /** Named argument expressions. spatial: chunk_x/chunk_y/chunk_z required (+ event_type/state/distance/decay/source_uuid); channel: channel_id/payload required (+ sender_uuid); actor: target_uuid/chunk_x/chunk_y/chunk_z/payload required. */
...
export type AppUsageSummaryQuery = { __typename?: 'Query', appUsageSummary: { __typename?: 'AppUsageSummary', appId: string, replicationSendBytes: string, replicationRecvBytes: string, graphqlSendBytes: string, graphqlRecvBytes: string, topGraphqlOperations: Array<{ __typename?: 'GraphqlOperationUsageRow', operationName: string, totalOps: string, sendBytes: string, recvBytes: string }> } };
